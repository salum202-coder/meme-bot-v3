...
def evaluate_positions(fetch_price_func, notify_func) -> None:
    ...
    for position in positions:
        ...
        elif current_price <= trailing_stop and highest_price > position["entry_price"]:
        ...
        notify_func(build_position_close_alert(position, current_price, pnl_amount, pnl_percent, exit_reason))
